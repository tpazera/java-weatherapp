...
public final class ProjectProperties<V, T, A> implements pl.knw.weatherapp.models.main.Properties<String, V> {
  ...
  public V get(final String name) {
    ...
    if (properties.containsKey(PROTOTYPE)) {
      pl.knw.weatherapp.models.main.Properties<String, V> prototype =
              (pl.knw.weatherapp.models.main.Properties<String, V>) properties.get(PROTOTYPE);
  ...
  public V put(final String name, final V value) {
    if (PROTOTYPE.equals(name) && !(value instanceof pl.knw.weatherapp.models.main.Properties)) {
  ...
  public boolean has(final String name) {
    ...
    if (properties.containsKey(PROTOTYPE)) {
      pl.knw.weatherapp.models.main.Properties<String, V> prototype = (pl.knw.weatherapp.models.main.Properties<String, V>) properties.get(PROTOTYPE);
